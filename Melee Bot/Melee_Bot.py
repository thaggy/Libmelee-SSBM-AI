...
while True:
    ...
    if gamestate.menu_state in [melee.Menu.IN_GAME, melee.Menu.SUDDEN_DEATH]:
        ...
        print(framedata.is_attack(gamestate.players[human_port].character , gamestate.players[human_port].action))
        ...
        if framedata.is_attack(melee.enums.Character.FOX  , gamestate.players[human_port].action):
       ...
       melee.MenuHelper.menu_helper_simple(gamestate,controller,melee.enums.Character.MARTH,melee.enums.Stage.FINAL_DESTINATION,"",0,0,False,False)